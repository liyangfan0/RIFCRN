...
def train_parser():
    ...
    parser.add_argument("--epoch",help="number of epochs before lr is cut by gamma",type=int,default=200)
    ...
    parser.add_argument("--val_epoch",help="number of epochs before eval on val",type=int,default=10)
    ...
    parser.add_argument('--decay_epoch',nargs='+',help='epochs that cut lr',type=int,default=[70,120])
