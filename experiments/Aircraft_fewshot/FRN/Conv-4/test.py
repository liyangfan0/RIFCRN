...
import yaml
sys.path.append('../../../../')
from models.FRN_DN4 import FRN
...
'''
test_path='D:/few_shot_classification/FRN/data/Aircraft_fewshot/test'
model_path='D:/few_shot_classification/FRN/trained_model_weights/Aircraft_fewshot/FRN/ResNet-12/model.pth'
