...
import yaml
sys.path.append('../../../../')
from models.FRN_weight2 import FRN
...
'''
test_path='D:/few_shot_classification/FRN/data/ship/test_pre'
model_path='D:/few_shot_classification/FRN/experiments/ship_fewshot/FRN/Conv-4/model_Conv-4-FRN-weight2.pth'
